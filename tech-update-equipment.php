...
if (!isset($_GET['assetnumber'])) {
    echo "<script>alert('No equipment selected!'); window.location.href='tech-equipment-management.php';</script>";
    exit();
}
...
if ($stmt = mysqli_prepare($link, $sql)) {
    ...
    if (!$equipment) {
        echo "<script>alert('Equipment not found!'); window.location.href='tech-equipment-management.php';</script>";
        exit();
    }
