...
if (isset($_POST['btn_confirm_delete'])) {
    $assetToDelete = trim($_POST['delete_assetnumber']);
    $showDeleteConfirmModal = true;
}

if (isset($_POST['btn_delete_yes'])) {
    $assetnumber = trim($_POST['delete_assetnumber']);
    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if ($logStmt = mysqli_prepare($link, $sql)) {
                ...
                mysqli_stmt_bind_param($logStmt, "ssssss", $date, $time, $action, $module, $assetnumber, $performedby);
    ...
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            <section class="control-panel">
                ...
                <div class="action-buttons">
                    <a href="tech-create-equipment.php" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add</a>
            ...
            <section class="table-section">
                ...
                function buildTable($result) {
                    if (mysqli_num_rows($result) > 0) {
                        echo "<table>";
                        echo "<tr><th>Asset Number</th><th>Serial Number</th><th>Type</th><th>Branch</th><th>Status</th><th>Created By</th><th>Actions</th></tr>";
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='tech-update-equipment.php?assetnumber=" . htmlspecialchars($row['assetnumber']) . "' class='btn update-btn'>";
                            echo "<i class='fa-solid fa-pen'></i>";
                            echo "</a>";
                            echo "<form action='' method='POST' class='inline-form'>";
                            echo "<input type='hidden' name='delete_assetnumber' value='" . htmlspecialchars($row['assetnumber']) . "'>";
        ...
        <div id="deleteConfirmModal" class="modal" style="<?php echo $showDeleteConfirmModal ? 'display: block;' : 'display: none;'; ?>">
            <div class="modal-content complete-confirm-modal">
                ...
                <form action="" method="POST" class="modal-form">
                    <input type="hidden" name="delete_assetnumber" value="<?php echo htmlspecialchars($assetToDelete); ?>">
        ...
        <div id="deleteSuccessModal" class="modal" style="<?php echo $showDeleteSuccessModal ? 'display: block;' : 'display: none;'; ?>">
            <div class="modal-content success-modal">
                ...
                <p>Equipment Successfully Deleted!</p>
