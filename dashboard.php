    ...
    <div class="content">
        ...
        <div class="container">
            <div class="management-grid">
                <a href="accounts-management.php" class="management-card">
                ...
                <a href="equipment-management.php" class="management-card">
                    <div class="card-front">
                ...
                <a href="ticket-management.php" class="management-card">
                    <div class="card-front">
