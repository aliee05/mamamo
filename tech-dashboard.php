...
<head>
    ...
    <title>Technical Dashboard - AU Technical Support</title>
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="management-grid">
                <a href="tech-equipment-management.php" class="management-card">
                    <div class="card-front">
                        <i class="fa-solid fa-tools card-icon"></i>
                        <h3>Equipment</h3>
                    </div>
                    <div class="card-back">
                        <i class="fa-solid fa-tools card-icon"></i>
                ...
                <a href="tech-ticket-management.php" class="management-card">
                    <div class="card-front">
