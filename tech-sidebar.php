    ...
    <nav class="sidebar shadow-lg vh-100 d-flex flex-column p-4">
        ...
        <ul class="nav flex-column mt-4 flex-grow-1">
            <li class="nav-item mb-3">
                <a href="tech-dashboard.php" class="nav-link <?php echo ($GLOBALS['current_page'] == 'tech-dashboard.php') ? 'active' : ''; ?>">
                    <i class="fa-solid fa-chart-line me-3"></i> Dashboard
                </a>
            </li>
            <li class="nav-item mb-3">
                <a href="tech-equipment-management.php" class="nav-link <?php echo ($GLOBALS['current_page'] == 'tech-equipment-management.php') ? 'active' : ''; ?>">
                    <i class="fa-solid fa-tools me-3"></i> Equipment Management
                </a>
            </li>
            <li class="nav-item mb-3">
                <a href="tech-ticket-management.php" class="nav-link <?php echo ($GLOBALS['current_page'] == 'tech-ticket-management.php') ? 'active' : ''; ?>">
    ...
    <div class="w-100">
        <div class="top-bar shadow-sm d-flex align-items-center justify-content-between p-3">
            ...
            <div class="d-flex align-items-center">
                <div class="home-icon">
                    <a href="tech-dashboard.php" class="icon-3d"><i class="fa-solid fa-house fa-lg"></i></a>
                </div>
...
.sidebar .nav-link {
    ...
    position: relative;
    margin: 0 12px;
    background: linear-gradient(135deg, rgba(25, 118, 210, 0.1), rgba(25, 118, 210, 0.2)); /* Subtle blue gradient */
}
...
.top-bar {
    ...
    border-bottom: 1px solid rgba(25, 118, 210, 0.3); /* Subtle blue border */
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initialActive = storedActive || currentPage || 'tech-dashboard.php';
