    ...
    if($stmt = mysqli_prepare($link, $sql)) {
        ...
        if(mysqli_stmt_execute($stmt)) {
            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                if(strtoupper($accounts['usertype']) === "TECHNICAL") {
                    session_start();
                    $_SESSION['username'] = $accounts['username'];
                    $_SESSION['usertype'] = $accounts['usertype'];
                    header("location: tech-dashboard.php");
                } else {
                    $error_message = "<span class='error-message'><i class='fa-solid fa-exclamation-circle'></i> This login is for TECHNICAL accounts only.</span>";
                }
            } else {
    ...
    <div class="login-container">
        <div class="left-panel">
            ...
            <div class="system-info">
                <span class="status">TECHNICAL <i class="fa-solid fa-circle-check"></i></span>
            </div>
        </div>
